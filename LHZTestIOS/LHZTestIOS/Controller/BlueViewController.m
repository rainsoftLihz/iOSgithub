...
//  LHZTestIOS
//
//  Created by rainsoft on 17/2/21.
...
@interface BlueViewController ()<CBCentralManagerDelegate,CBPeripheralDelegate>
...
//2.只要中心管理者初始化 就会触发此代理方法 判断手机蓝牙状态
- (void)centralManagerDidUpdateState:(CBCentralManager *)central
{
    switch (central.state) {
        ...
        case 5:
        {
            ...
            [self.cMgr scanForPeripheralsWithServices:nil                                               options:scanForPeripheralsWithOptions]; // dict,条件
                  ...
                  RSSI:(NSNumber *)RSSI // 外设发出的蓝牙信号强度
{
    ...
    //NSLog(@"%s, name = %@, cetral = %@,state = %ld, advertisementData = %@, RSSI = %@", __FUNCTION__, peripheral.name, central, peripheral.state, advertisementData, RSSI);
